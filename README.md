...
The notebook for my emotion-classification-api model, using a frozen HuBERT feature extractor and feeding it into a classifier head. Achieves 79% test accuracy.
